...
7. Infinite-horizon MDPS are solved by iterative approaches: 
...
\[ 
    \pi^* = \argmax\pi \EV{\rho^\pi}[R(\tau)], \quad R(\tau) = \sum_{t=0}^H \gamma^t r_t
\] 
...
:::{.definition #finiteVI name="finite-horizon value iteration"}
